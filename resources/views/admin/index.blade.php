                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Crediti Rimanenti</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($utenti as $utente)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $utente->crediti_rimanenti }} / {{ $utente->crediti_iniziali }}</td>
